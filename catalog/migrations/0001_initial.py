# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-02-20 02:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.TextField(blank=True, choices=[('current', 'Rentable'), ('damaged', 'Damaged'), ('retired', 'No Longer Rentable'), ('dirty', 'Dirty')], null=True)),
            ],
            options={
                'abstract': False,
            },
